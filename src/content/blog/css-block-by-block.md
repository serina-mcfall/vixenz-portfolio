...
For Moonlit, the design was as important as the build and the planning. Working out what I wanted that site to look like — the moon palette, the gold accents, the rating widget shaped like phases — *was* what made the final result possible. The CSS came out of the design decisions, not the other way around.
...
I am learning, in my own way, how to notice errors and what they mean. That is the actual skill I am building. Not "fewer errors" — better instincts for what each error is telling me.
